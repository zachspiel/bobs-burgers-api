...
var fs_1 = require("fs");
var ROUTES = ['characters', 'pestControlTruck', 'endCreditsSequence', 'storeNextDoor'];
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2: return [2 /*return*/, res.status(400).json({
                    data: "Error while getting data for route: ".concat(route, ". Available options are: characters, pescControlTrucks, endCredits or storeNextDoor.")
                })];
        }
    });
}); };
            ...
            case 1:
                ...
                if (isIndexInValid(requestedData, id)) {
                    return [2 /*return*/, res.status(400).json({
                            data: "Error: id ".concat(id, " is outside of bounds 1 - ").concat(requestedData.length - 1)
                        })];
                }
                return [2 /*return*/, res.status(200).json({
                        data: requestedData[id - 1]
                    })];
            case 2: return [2 /*return*/, res.status(400).json({
                    data: "Error while retreiving data with id ".concat(req.params.id, ".")
                })];
        }
    });
}); };
...
exports["default"] = { getAllData: getAllData, getSpecificItem: getSpecificItem };
