...
describe("End Credits Sequences", async () => {
  describe("/GET endCreditsSequence", async () => {
  ...
  describe("/GET endCreditsSequence/1", async () => {
  ...
  describe("/GET endCreditsSequence?limit=2", async () => {
  ...
  describe("/GET endCreditsSequence/[1,2,3]", async () => {
  ...
  describe("/GET endCreditsSequence?skip=3", async () => {
